...
const SystemInfoComponent = () => {
    ...
    return (_jsxs("div", { className: "system-info-container", children: [_jsxs("div", { className: "system-info-header", children: [_jsx("h1", { children: "Performance Log Buch" }), _jsx("button", { className: "save-button", onClick: handleSave, children: "Speichern" })] }), _jsxs("div", { className: "system-info-row", children: [_jsxs("div", { className: "system-info-item", children: [_jsx("strong", { children: "Benutzername:" }), " ", info.username] }), _jsxs("div", { className: "system-info-item", children: [_jsx("strong", { children: "Datum:" }), " ", info.date] }), _jsxs("div", { className: "system-info-item", children: [_jsx("strong", { children: "Uhrzeit von:" }), " ", info.timeFrom] }), _jsxs("div", { className: "system-info-item", children: [_jsx("strong", { children: "Uhrzeit bis:" }), " ", info.timeTo] })] }), _jsxs("div", { className: "table-container", children: [_jsx("h2", { children: "Daten\u00FCbersicht" }), _jsxs("table", { className: "data-table", children: [_jsx("thead", { children: _jsx("tr", { children: tableData.length > 0 &&
